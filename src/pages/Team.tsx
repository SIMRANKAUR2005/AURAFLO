...
const team: TeamMember[] = [
  ...
  },
  {
    ...
    social: {
      linkedin: "https://www.linkedin.com/in/priyam-ganguli",
      twitter: ""
    }
  },
  {
  ...
  },
  {
    ...
    social: {
      linkedin: "https://www.linkedin.com/in/vedika-chawla",
      twitter: ""
    }
  }
];
      ...
      <div className="container mx-auto px-4 pt-28 pb-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Meet the passionate individuals behind AuraFlo. Our diverse team brings together expertise in technology, design, and wellness to create innovative solutions for your practice.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {team.map((member) => (
            <Link
              ...
              className="group"
            >
              <div className="glass rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold mb-2 group-hover:text-aura-purple transition-colors duration-300">
                    {member.name}
                  </h3>
                  <p className="text-aura-purple mb-4">{member.role}</p>
