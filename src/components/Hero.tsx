        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="animate-fade-in-left">
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/product/auraflv-3" className="px-6 py-3 rounded-full bg-aura-purple hover:bg-aura-purple-light transition-colors duration-300 font-medium hover:shadow-lg hover:shadow-aura-purple/30 transition-all">
                Explore AuraFLV 3.0
              </Link>
                ...
                <div className="h-full w-full bg-gradient-to-br from-aura-purple/20 to-aura-green/20 rounded-xl flex items-center justify-center">
                  <div className="w-full h-full relative">
                    <img 
                      ...
                      alt="Person doing yoga on AuraFLV mat" 
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-aura-black/80 to-transparent flex flex-col items-center justify-end p-6">
                      <span className="text-2xl font-medium text-gradient mb-2">AURAFLV 3.0</span>
